...
Hex Inception is currently a macOS-only plug-in. Hex Inception requires a compatible multichannel audio source and a compatible hosted multichannel plug-in for its primary hexaphonic workflow.
